export const EMAIL = "charol04louisa@gmail.com";
export const IG_USERNAME = "charolin.sa";
export const IG_URL = `https://instagram.com/${IG_USERNAME}`;
...
export const PLACEHOLDER_LABEL = "[ADD HERE]";
