...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Charolin Louisa Aipassa" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Charolin Louisa Aipassa — Informatics Engineering Student" },
      { name: "twitter:title", content: "Charolin Louisa Aipassa — Informatics Engineering Student" },
      ...
      { name: "twitter:description", content: "Portfolio of Charolin Louisa Aipassa — Informatics Engineering student, AI community builder, and student leader at Universitas Sanata Dharma." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7e2768e8-60ee-4c95-a971-c1dff2c32ae5/id-preview-e5092216--b0fd3d5d-7d5f-4f0d-b1b1-2c33a52b0f3e.lovable.app-1783850937023.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7e2768e8-60ee-4c95-a971-c1dff2c32ae5/id-preview-e5092216--b0fd3d5d-7d5f-4f0d-b1b1-2c33a52b0f3e.lovable.app-1783850937023.png" },
    ],
    links: [
